...
<head>
    ...
    <style>
        ...
        /* ==========================================
           12. RESPONSIVE MOBILE FIXES (KHUSUS HP)
           ========================================== */
        @media (max-width: 768px) {
            ...
            .hero-section {
                ...
                background-image: linear-gradient(180deg, rgba(248, 250, 252, 0.95) 0%, rgba(248, 250, 252, 0.8) 60%, rgba(255, 255, 255, 0) 100%), url('img/gambar1.png');
            ...
            /* Tentang Section (CV Illustration) Mobile */
            h2.section-title[style*="3.5rem"] {
            ...
            /* Live Tracking Map Overlay Mobile */
            .map-overlay-card {
                width: 90% !important;
            ...
            .map-overlay-card .d-flex.gap-4 {
                width: 100%;
                justify-content: space-between;
                gap: 10px !important;
            }

            .map-overlay-card .border-start {
                border-left: 1px solid #dee2e6 !important;
                padding-left: 15px !important;
            }

            .map-overlay-card .border-start:first-child {
                ...
                <div class="col-lg-7" data-aos="fade-left" data-aos-delay="200">
                    <div class="position-relative bg-white p-2 rounded-4 shadow-lg" style="border: 1px solid #e2e8f0;">
                        ...
                        <div class="map-wrapper"
                            ...
                            <div class="map-overlay-card position-absolute bg-white p-3 shadow-lg d-flex align-items-center justify-content-between flex-wrap gap-3"
...
>>>>>>> 3fa08e0b33d77836c3685a295fcd1ee0a615269b
</html>